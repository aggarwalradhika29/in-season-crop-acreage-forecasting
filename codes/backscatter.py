# code to plot and save the backscatter curve of the pixel values of layer stacked image w.r.t. the ground points provided by the user
    ...
    for p in polar:
        ...
        for k in range(len(shpList)):
            ...
            for j in range(1, (rasterIn.count + 1)):
                ...
                # calculation of mean zonal statistics, grouped by the unique categories of crop in GT shape file
